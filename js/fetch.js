...
function agregarPokemon(nombre, tipo, sprites) {//aca defino parametros para modif. el html
    ...
    for (let i = 0; i < 1; i++){//loop que por cada url me imprime este codigo
        const div = document.createElement('div');
        div.innerHTML = ` <div class="pokemon pokemon">
        <img src="${sprites}" alt="Imagen del pokachi" class="m_pokemon_i">
    ...
    document.body.appendChild(fragment);//agrego el fragmento al body (html)
}
